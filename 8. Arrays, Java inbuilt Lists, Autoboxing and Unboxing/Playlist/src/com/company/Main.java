...
Playlist
        ...
        TIP:  In Album, use the findSong() method in addSong() and addToPlayList(String, LinkedList) to check if a
        song exists before proceeding.
        ...
        NOTE:  If you get an error from the Evaluate class, it's most likely the constructor. Check if you've
*/
...
//        This was just done to practice LinkedList traversing
...
//                        Displays song playing
    ...
    public static void printInstructions(){
        System.out.println("1 - go to previous song");
